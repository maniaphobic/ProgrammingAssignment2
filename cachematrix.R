...
# cacheSolve
#
# This function computes a matrix inverse from its first argument
# 
# Arguments:
# 
#   x: a list generated by makeCacheMatrix
# 
#   ... (optional): additional arguments
# 
# Return value: the matrix's inverse
#
...
cacheSolve <- function(x, ...) {
    ...
    populate_cache <- function(thisMatrix) {
        if (x$cache_is_empty() || x$cache_is_dirty(thisMatrix)) {
            print("[NOTICE] Populating the cache")
